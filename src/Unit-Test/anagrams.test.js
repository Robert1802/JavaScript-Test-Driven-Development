...
describe('isAnagram - basic functionality', () => {
    ...
    it('returns false when either of the strings has extra letters', () => {
        ...
        const actual2 = isAnagram('elbow', 'belows');
    ...
    it('return true with two anagrams with space on words', () =>{
        const expected = true;
    ...
    it('return true with two anagrams if one is Upper case and the other is not', () =>{
        const expected = true;
